...
<head>
	...
	<!-- JQuery Libraries -->
	<script type="text/javascript" charset="UTF-8" src="${ctx}/js/libsJQuery/jquery-3.5.0.min.js"></script>
	<script type="text/javascript" charset="UTF-8" src="${ctx}/js/libsJQuery/jquery.validate.min.js"></script>
